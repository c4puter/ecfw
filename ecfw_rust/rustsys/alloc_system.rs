...
#[no_mangle]
pub unsafe extern "C" fn __rust_alloc(
    size: usize,
    align: usize,
    _err: *mut u8,
) -> *mut u8
...
#[no_mangle]
pub unsafe extern "C" fn __rust_alloc_zeroed(
    size: usize,
    align: usize,
    err: *mut u8,
) -> *mut u8
...
#[no_mangle]
pub unsafe extern "C" fn __rust_dealloc(
    ptr: *mut u8,
    _old_size: usize,
    _align: usize,
)
...
) -> *mut u8
{
    if old_align != new_align {
        panic!(
            "realloc requested change in alignment ({} to {})",
            old_align,
            new_align
        );
    }
    ...
    if new_size < old_size {
        debug!(
            DEBUG_ALLOC,
            "realloc 0x{:08x} to lower size - doing nothing",
            (ptr as usize)
        );
        return ptr;
    }
