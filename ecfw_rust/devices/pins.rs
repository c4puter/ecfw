...
pin_table!{
    ...
    FPGA_DONE0,         SamGpio, port => PIOA, pin =>  8, mode => Input,  default => false, invert => true;
    FPGA_DONE1,         SamGpio, port => PIOA, pin =>  7, mode => Input,  default => false, invert => true;
    FPGA_DONE2,         SamGpio, port => PIOA, pin =>  6, mode => Input,  default => false, invert => true;
    FPGA_INIT,          SamGpio, port => PIOA, pin =>  5, mode => Input,  default => false, invert => true;
    ...
    FPGA_PROG0,         SamGpio, port => PIOA, pin => 12, mode => Output, default => false, invert => true;
